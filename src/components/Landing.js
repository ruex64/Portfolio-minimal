...
const Landing = () => {
  ...
  return (
    <section className="section">
      ...
      <p ref={typedRef}></p>
      <div>
        <a href="https://drive.google.com/drive/folders/1gHxmYm6TSZkR-CmXTus3fI9WH7RQye4Q?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn">View CV</a>
